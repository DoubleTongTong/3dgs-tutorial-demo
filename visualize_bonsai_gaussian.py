...
def main():
    ...
    ax_full.set_title(f"Bonsai Optimized Gaussians (Original {width}x{height})", fontsize=14, fontweight='bold', pad=12)
    ax_full.axis('off')
    output_full = "bonsai_gaussian_original.png"
    ...
    ax_half.set_title(f"Bonsai Optimized Gaussians (Downscaled {downscale}x: {w_half}x{h_half})", fontsize=14, fontweight='bold', pad=12)
    ax_half.axis('off')
    output_half = "bonsai_gaussian_scaled.png"
